...
const server = http.createServer((req, res) => {
    if (req.url === '/') {
        ...
        // Adding console.log outputs to the response
        res.write('<h2>Console Log Outputs:</h2>');
        res.write('<pre>');
        res.write(`${movies.movies[1].title}\n`);
        res.write(`${movies.movies[1].director}\n`);
        res.write(`${movies.movies[1].actors}\n`);
        res.write(`${movies.movies[2].title}\n`);
        res.write(`${movies.movies[2].director}\n`);
        res.write(`${movies.movies[2].year}\n`);
        res.write('</pre>');
